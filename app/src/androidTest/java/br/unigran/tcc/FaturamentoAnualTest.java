...
import br.unigran.tcc.ViewModel.FaturamentoAnual;

@RunWith(AndroidJUnit4.class)
@LargeTest
public class FaturamentoAnualTest {

    @Test
    public void testCalcularFaturamento() {
        try (ActivityScenario<FaturamentoAnual> scenario = ActivityScenario.launch(FaturamentoAnual.class)) {
