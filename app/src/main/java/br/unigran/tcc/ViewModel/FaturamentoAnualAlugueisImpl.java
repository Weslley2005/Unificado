...
public class FaturamentoAnualAlugueisImpl {
    private FirebaseFirestore db;
    private CollectionReference comprasRef;

    public FaturamentoAnualAlugueisImpl() {
    ...
    public void calcularFaturamentoAnualAlugueis(String dataInicio, String dataFim, final FaturamentoListener listener) {
