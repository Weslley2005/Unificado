...
public class FaturamentoMensalAdapter extends RecyclerView.Adapter<FaturamentoMensalAdapter.ProdutoViewHolder> {

    private List<FaturamentoMensalImpl.ProdutoFaturamento> produtos;

    public FaturamentoMensalAdapter(List<FaturamentoMensalImpl.ProdutoFaturamento> produtos) {
    ...
    public ProdutoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_faturamento_mensal, parent, false);
        return new ProdutoViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ProdutoViewHolder holder, int position) {
        FaturamentoMensalImpl.ProdutoFaturamento produto = produtos.get(position);
