...
public class DetalhesHistoricoAluguelAdapter extends RecyclerView.Adapter<DetalhesHistoricoAluguelAdapter.ItemAluguelViewHolder> {

    private List<ItemAluguel> listaItens;

    public DetalhesHistoricoAluguelAdapter(List<ItemAluguel> listaItens) {
        this.listaItens = listaItens;
    }

    @NonNull
    @Override
    public DetalhesHistoricoAluguelAdapter.ItemAluguelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_item_aluguel, parent, false);
        return new DetalhesHistoricoAluguelAdapter.ItemAluguelViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DetalhesHistoricoAluguelAdapter.ItemAluguelViewHolder holder, int position) {
