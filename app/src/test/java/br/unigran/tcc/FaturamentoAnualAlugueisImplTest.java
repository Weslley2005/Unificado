...
import br.unigran.tcc.ViewModel.FaturamentoAnualAlugueisImpl;

public class FaturamentoAnualAlugueisImplTest {
    private FaturamentoAnualAlugueisImpl.ProdutoFaturamento produto;

    @Before
    public void setup() {
        produto = new FaturamentoAnualAlugueisImpl.ProdutoFaturamento("ProdutoTeste");
    }
