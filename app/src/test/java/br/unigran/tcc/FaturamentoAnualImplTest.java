...
import br.unigran.tcc.ViewModel.FaturamentoAnualImpl;

public class FaturamentoAnualImplTest {
    private FaturamentoAnualImpl.ProdutoFaturamento produto;

    @Before
    public void setup() {
        produto = new FaturamentoAnualImpl.ProdutoFaturamento("ProdutoTeste");
    }
