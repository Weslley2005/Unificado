...
import br.unigran.tcc.ViewModel.FaturamentoMensalAlugueisImpl;

public class FaturamentoMesalAluguelImplTest {
    private FaturamentoMensalAlugueisImpl.ProdutoFaturamento produto;

    @Before
    public void setup() {
        produto = new FaturamentoMensalAlugueisImpl.ProdutoFaturamento("ProdutoTeste");
    }
