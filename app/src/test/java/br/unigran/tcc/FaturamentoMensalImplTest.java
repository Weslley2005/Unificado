...
import br.unigran.tcc.ViewModel.FaturamentoMensalImpl;

public class FaturamentoMensalImplTest {
    private FaturamentoMensalImpl.ProdutoFaturamento produto;

    @Before
    public void setup() {
        produto = new FaturamentoMensalImpl.ProdutoFaturamento("ProdutoTeste");
    }
