...
import br.unigran.tcc.ViewModel.FaturamentoDiarioImpl;

public class FaturamentoDiarioImplTest {
    private FaturamentoDiarioImpl.ProdutoFaturamento produto;

    @Before
    public void setup() {
        produto = new FaturamentoDiarioImpl.ProdutoFaturamento("ProdutoTeste");
    }
